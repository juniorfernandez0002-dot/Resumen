<template>
  <div class="space-y-8 animate-fade-in pb-12">
    <header class="border-b border-app-border pb-6">
      <h1 class="text-3xl font-bold text-app-text mb-2">Caminos Eulerianos</h1>
      <p class="text-app-text-muted">Recorriendo el grafo sin repetir</p>
    </header>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-app-surface p-6 rounded-xl border border-app-border shadow-sm flex flex-col justify-center">
        ...
        <p class="text-app-text-muted text-sm mb-4">
          Este módulo introduce los conceptos clave de <strong>Caminos Eulerianos</strong>. 
      ...
      <div class="bg-app-surface p-6 rounded-xl border border-app-border shadow-sm">
        ...
        <div class="bg-app-bg p-4 rounded-lg border border-app-border">
          <p class="text-center text-app-text-muted text-sm">Fórmula base para Caminos Eulerianos</p>
    ...
    <StepByStepExercise :exerciseSteps="moduleSteps" nextModuleRoute="/modulo/conjuntos" />
  </div>
</template>
